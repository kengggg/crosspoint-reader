#pragma once
// FreeRTOS task shim for Emscripten web emulator.
...
// Creates a task. In the emulator, this registers the task for cooperative scheduling.
...
// Delays the calling task. In the emulator, this yields back to the main fiber.
void vTaskDelay(TickType_t xTicksToDelay);

// Run one round of background tasks (called from emulator main loop).
