// CrossPoint Reader Web Emulator — Shell JavaScript
...
document.addEventListener('keydown', function(e) {
  ...
  if (btn !== undefined) {
    e.preventDefault();
    Module._emulator_button_down(btn);
...
document.addEventListener('keyup', function(e) {
  ...
  if (btn !== undefined) {
    e.preventDefault();
    Module._emulator_button_up(btn);
    const btnEl = document.querySelector(`.hw-btn[data-btn="${btn}"]`);
...
document.querySelectorAll('.hw-btn').forEach(btn => {
  ...
  btn.addEventListener('mousedown', (e) => {
    e.preventDefault();
    Module._emulator_button_down(idx);
    btn.classList.add('pressed');
  });
  btn.addEventListener('mouseup', (e) => {
    e.preventDefault();
    Module._emulator_button_up(idx);
...
Module.onRuntimeInitialized = function() {
  statusText.textContent = 'Emulator running';
};
